...
OMNeT++ and INET based UAV swarm and sensor network simulation framework
...
Demo media was removed from this lightweight Git upload package to keep the repository size manageable.
...
Statistics example media was removed from this lightweight Git upload package.
...
Project structure diagram media was removed from this lightweight Git upload package.

**MAVSIMNET architecture diagram**
Architecture diagram media was removed from this lightweight Git upload package.

**Project Message Diagram**
Project message diagram media was removed from this lightweight Git upload package.
...
*.quads[1].failures[1].failureChance = 0.001
 ...
 Failure message diagram media was removed from this lightweight Git upload package.
...
Simple protocol showcase media was removed from this lightweight Git upload package.
